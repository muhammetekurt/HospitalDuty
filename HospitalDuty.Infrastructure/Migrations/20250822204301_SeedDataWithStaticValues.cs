    ...
    public partial class SeedDataWithStaticValues : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), "Üniversiteler Mahallesi Bilkent Bulvarı", "Ankara", new Guid("22222222-2222-2222-2222-222222222222"), "Çankaya", "info@ankarashehir.gov.tr", "Ankara Şehir Hastanesi", "0312 123 45 67", "www.ankarashehir.gov.tr" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("33333333-3333-3333-3333-333333333333"), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("66666666-6666-6666-6666-666666666666"), "Acil Servis" },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("77777777-7777-7777-7777-777777777777"), "Dahiliye" },
                    { new Guid("55555555-5555-5555-5555-555555555555"), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("88888888-8888-8888-8888-888888888888"), "Genel Cerrahi" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("22222222-2222-2222-2222-222222222222"), new Guid("33333333-3333-3333-3333-333333333333"), "mehmet.ozkan@ankarashehir.gov.tr", "Mehmet", "Özkan", "0532 111 11 11", "", 0 },
                    { new Guid("66666666-6666-6666-6666-666666666666"), new Guid("33333333-3333-3333-3333-333333333333"), "ayse.demir@ankarashehir.gov.tr", "Ayşe", "Demir", "0532 222 22 22", "", 1 },
                    { new Guid("77777777-7777-7777-7777-777777777777"), new Guid("44444444-4444-4444-4444-444444444444"), "ali.yilmaz@ankarashehir.gov.tr", "Ali", "Yılmaz", "0532 333 33 33", "", 1 },
                    { new Guid("88888888-8888-8888-8888-888888888888"), new Guid("55555555-5555-5555-5555-555555555555"), "fatma.kaya@ankarashehir.gov.tr", "Fatma", "Kaya", "0532 444 44 44", "", 1 },
                    { new Guid("99999999-9999-9999-9999-999999999999"), new Guid("33333333-3333-3333-3333-333333333333"), "mustafa.celik@ankarashehir.gov.tr", "Mustafa", "Çelik", "0532 555 55 55", "", 4 },
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new Guid("33333333-3333-3333-3333-333333333333"), "zeynep.arslan@ankarashehir.gov.tr", "Zeynep", "Arslan", "0532 666 66 66", "", 4 },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new Guid("44444444-4444-4444-4444-444444444444"), "can.guven@ankarashehir.gov.tr", "Can", "Güven", "0532 777 77 77", "", 4 },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), new Guid("55555555-5555-5555-5555-555555555555"), "selin.aktas@ankarashehir.gov.tr", "Selin", "Aktaş", "0532 888 88 88", "", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), new Guid("33333333-3333-3333-3333-333333333333"), new Guid("66666666-6666-6666-6666-666666666666"), new DateTime(2025, 8, 22, 16, 0, 0, 0, DateTimeKind.Unspecified), "Sabah vardiyası", 0, new DateTime(2025, 8, 22, 8, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), new Guid("33333333-3333-3333-3333-333333333333"), new Guid("99999999-9999-9999-9999-999999999999"), new DateTime(2025, 8, 23, 8, 0, 0, 0, DateTimeKind.Unspecified), "Gece vardiyası", 1, new DateTime(2025, 8, 22, 16, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("ffffffff-ffff-ffff-ffff-ffffffffffff"), new Guid("44444444-4444-4444-4444-444444444444"), new Guid("77777777-7777-7777-7777-777777777777"), new DateTime(2025, 8, 22, 17, 0, 0, 0, DateTimeKind.Unspecified), "Günlük mesai", 0, new DateTime(2025, 8, 22, 9, 0, 0, 0, DateTimeKind.Unspecified) }
                });
        }
